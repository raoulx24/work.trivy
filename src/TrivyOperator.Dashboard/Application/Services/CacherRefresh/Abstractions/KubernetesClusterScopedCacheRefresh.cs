        ...
        where TBackgroundQueue : IBackgroundQueue<TKubernetesWatcherEvent, TKubernetesObject>
{
    ...
    protected override void ProcessAddEvent(TKubernetesWatcherEvent watcherEvent)
    {
        
    }

    protected override void ProcessDeleteEvent(TKubernetesWatcherEvent watcherEvent)
    {
