...
public class NamespaceWatcher : ClusterScopedWatcher<V1NamespaceList, V1Namespace, IBackgroundQueue<V1Namespace>, WatcherEvent<V1Namespace>>
{
    ...
    protected override async Task EnqueueWatcherEventWithError(IKubernetesObject<V1ObjectMeta>? sourceKubernetesObject)
    {
        ...
        WatcherEvent<V1Namespace> watcherEvent = new() { KubernetesObject = v1Namespace, WatcherEventType = WatchEventType.Error };
